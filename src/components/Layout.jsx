      ...
      <header id="fintrack-topbar" style={s.topbar}>
        <div style={s.topbarInner}>
          ...
          <button onClick={() => navigate('/dashboard')} style={s.brand}>
            <div style={s.brandIcon}><Wallet size={16} color="#fff" /></div>
            ...
            <nav style={s.sidebarNav}>
              {sidebarItems.map(({ path, icon: Icon, label }) => (
                <button
                  ...
                  style={isActive(path) ? s.sidebarItemActive : s.sidebarItem}
                >
                  <Icon size={18} />
      ...
      <nav id="fintrack-bottomnav" style={s.bottomNav}>
        {bottomNavItems.slice(0, 2).map(({ path, icon: Icon, label }) => (
          <button
            key={path}
            onClick={() => navigate(path)}
            style={isActive(path) ? s.bnItemActive : s.bnItem}
          >
            <Icon size={22} />
            <span>{label}</span>
          </button>
...
const s = {
  ...
  sidebarName: { 
    fontSize: '13.5px', fontWeight: '700', color: 'var(--gray-800)', 
  ...
  sidebarItem: {
    ...
    fontSize: '14px', fontWeight: '500', color: 'var(--gray-500)',
  ...
  sidebarBottom: { 
    ...
    gap: '8px', borderTop: '1px solid var(--border)' 
  },
  sidebarAddBtn: {
  ...
  sidebarLogout: {
    ...
    borderRadius: 'var(--radius-sm)',
    fontSize: '13.5px', fontWeight: '500', color: 'var(--gray-500)', 
  ...
  bnItem: {
    ...
    background: 'none', border: 'none',
    color: 'var(--gray-400)', fontSize: '10px', fontWeight: '500',
  ...
  bnFab: {
    ...
    marginTop: '-16px', flexShrink: 0, cursor: 'pointer'
  }
}