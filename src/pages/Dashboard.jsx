...
import { Plus, List, LogOut, TrendingUp, TrendingDown, Wallet, BarChart2 } from "lucide-react";
    ...
    <div style={s.page}>
      ...
      <div style={s.container}>
        ...
        <div style={s.balanceCard}>
          ...
          <p style={{ ...s.balanceAmount, color: balance >= 0 ? "#fff" : "var(--red-pale)" }}>{formatRupiah(balance)}</p>
        ...
        <div style={s.actionRow}>
          ...
          <button onClick={() => navigate("/budget")} style={s.actionBtnOutline}>
            <Wallet size={18} />
            <span>Budget</span>
          </button>
        </div>
          ...
          <>
            ...
            <div style={s.section}>
              <div style={s.sectionHeader}>
                ...
                <button onClick={() => navigate("/transactions")} style={s.seeAll}>
                  Lihat semua
                </button>
              </div>
              <div style={s.trxList}>
                {recentTransactions.map((trx) => (
                  <div key={trx.id} style={s.trxItem}>
                    <div style={s.trxLeft}>
                      ...
                      >
                        {trx.type === "income" ? <TrendingUp size={16} color="var(--green)" /> : <TrendingDown size={16} color="var(--red)" />}
                      </div>
                      <div>
